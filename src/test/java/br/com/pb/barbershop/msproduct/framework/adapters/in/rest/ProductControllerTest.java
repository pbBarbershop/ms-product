...
class ProductControllerTest {
    ...
    void updateProduct() throws Exception {
        ...
        when(productService.update(any(), any())).thenReturn(productResponse);
        MvcResult result = mockMvc
            .perform(
                MockMvcRequestBuilders
                    .put(ID_URL)
    ...
    private ProductDTO getProductDTO() {
        return ProductDTO.builder().name(NAME).description(DESCRIPTION).value(VALUE).quantity(QUANTITY).build();
    }
}
